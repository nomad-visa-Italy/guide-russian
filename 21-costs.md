...
> 🟡 Суммы ниже — сводка из соответствующих разделов гайда (см. ссылки в колонке «Подробнее»); маркеры надёжности и источники указаны в самих разделах. Тарифы и сборы меняются — проверяйте актуальные суммы.
...
| Билет в один конец | от 34 000 руб. | [05-documents-common.md](05-documents-common.md) |
...
| Полный кейс с агентством (семья 3) | ~20 000 EUR | [11-application.md](11-application.md) |
