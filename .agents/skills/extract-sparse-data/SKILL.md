...
**Обязательный контекст:** источник `[emigrantista #1234]` / `[rutoitalychat #5678]`, город/консульство/квестура, тип занятости, дата.

**Кейсы:** даже если сообщение не проходит полный DN_VERIFY, но содержит личный кейс подачи/получения — вставить в `15-cases.md` (кейс ценен сам по себе). Полная библиотека regex-паттернов для поиска кейсов: `../update-guide/references/case-patterns.md`.
...
- [ ] Кейсы подачи/получения вставлены в `15-cases.md`
