...
> **Парные скилы:** при изменении этого скила (чеклист, формат, правила) — обновить аналогичные пункты в `.claude/skills/extract-sparse-data/SKILL.md` и `.agents/skills/update-guide/SKILL.md` / `.claude/skills/update-guide/SKILL.md`. Все четыре скила пишут в один гайд и должны следовать одним и тем же правилам.
