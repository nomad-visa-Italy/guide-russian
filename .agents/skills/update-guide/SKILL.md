...
> **Парные скилы:** при изменении этого скила (чеклист, формат, правила) — обновить аналогичные пункты в `.claude/skills/update-guide/SKILL.md` и `.agents/skills/extract-sparse-data/SKILL.md` / `.claude/skills/extract-sparse-data/SKILL.md`. Все четыре скила пишут в один гайд и должны следовать одним и тем же правилам.
