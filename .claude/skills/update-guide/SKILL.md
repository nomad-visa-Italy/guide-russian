...
> **Парные скилы:** при изменении этого скила (чеклист, формат, правила) — обновить аналогичные пункты в остальных трёх скилах: `.claude/skills/extract-sparse-data/SKILL.md`, `.agents/skills/update-guide/SKILL.md`, `.agents/skills/extract-sparse-data/SKILL.md`. Все четыре скила пишут в один гайд и должны следовать одним и тем же правилам.
