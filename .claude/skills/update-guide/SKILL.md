...
**Перед обновлением гайда** — пройди все треды и найди полные кейсы подачи/получения визы DN или ВНЖ DN. Вставь их в `15-cases.md`. Это приоритетнее всего остального.
...
- ID сообщения(й) для ссылки `[Чат #ID]`

### Шаг 4: Обновление гайда

На основе извлечённого обнови файлы гайда (01-overview.md ... 16-helpers.md):
...
Формат ссылок: `[Чат #1234]` (ID из дампа). Для внешних: `[VMS Москва]`, `[Консульство Москва]`, URL.
...
- [ ] Полные кейсы найдены и вставлены в `15-cases.md` (Шаг 2)
- [ ] Каждое утверждение имеет ссылку `[Чат #ID]` и дату
